...
| OCR-003 | Một khung hoàn tất dưới **400 ms** | Đo trên khung game thật | N02 | **CHƯA ĐẠT** — 4.863 → **1.036 ms** sau M3.1 |
...
**Đọc bảng này:** 63/93 yêu cầu đã có test đang chạy. Phần chưa xây tập trung đúng bốn chỗ —
